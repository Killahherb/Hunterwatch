...
local PROCS = {
    ...
    },
    {
        label = "Searing",
        playerOnly = true,
        match = { "spell_fire_selfdestruct", "searing", "upgrademoonglaive", "multishot" },
    ...
    },
    {
        label = "BlkArrow",
        playerOnly = true,
        match = { "darkarrow", "blackarrow", "impalingbolt", "shadow_painspike" },
    ...
    },
    {
        label = "Poison",
        playerOnly = true,
        match = { "poisonsting", "nature_slowpoison", "serpentsting" },
...
DEFAULT_CHAT_FRAME:AddMessage("|cff00ccffHunterWatch v1.7|r loaded. Click minimap icon or type /hw")
